/**
 * E2E tests for POST /v1/projects/:projectId/pipeline/launch-workspace (I12 of the SSOT program).
 * Runs against MongoMemoryServer — no
...
describe("Pipeline launch-workspace E2E", () => {
    beforeAll(async () => {
