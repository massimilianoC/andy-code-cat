...
| [docs/specs/DOCUMENT_FORMAT_COVERAGE_EXTENSION_PLAN.md](specs/DOCUMENT_FORMAT_COVERAGE_EXTENSION_PLAN.md) | Proposed additive extension of document-format coverage in the enrichment pipeline — legacy `.doc` (OLE), RTF and ODT parsers inside the existing `DocumentParser` pattern, four-map mime synchronization, package research and tests |
