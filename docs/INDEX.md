...
| [docs/guides/AGENT_RELEASE_CHECKLIST.md](guides/AGENT_RELEASE_CHECKLIST.md) | English checklist for agents handling branch, commit, merge, release, and hotfix flows |
